# owner-manual - PDF page 1

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-01.png`
- Detail render: `knowledge/renders/owner-manual/page-01-detail.png`
...
- Cover identifies the Vulcan OmniPro 220, item 57812; no diagram semantics beyond the title and product image.

---

# owner-manual - PDF page 2

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-02.png`
- Detail render: `knowledge/renders/owner-manual/page-02-detail.png`
...
- Table-of-contents hierarchy and safety-symbol legend were checked against the rendered page.

---

# owner-manual - PDF page 3

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-03.png`
- Detail render: `knowledge/renders/owner-manual/page-03-detail.png`
...
- Two-column safety layout and fume/gas warning icons were checked; warnings are represented by the extracted text.

---

# owner-manual - PDF page 4

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-04.png`
- Detail render: `knowledge/renders/owner-manual/page-04-detail.png`
...
- Electrical-safety warnings, icons, and two-column reading order were checked against the render.

---

# owner-manual - PDF page 5

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-05.png`
- Detail render: `knowledge/renders/owner-manual/page-05-detail.png`
...
- Welder use/care and maintenance warnings use a two-column layout; extracted text covers the visual callouts.
...
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-06.png`
- Detail render: `knowledge/renders/owner-manual/page-06-detail.png`
...
- Grounding illustration and safety-symbol table were checked; the plug/outlet relationship agrees with the text.
...
# owner-manual - PDF page 8

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review, local_ocr`
- Render: `knowledge/renders/owner-manual/page-08.png`
- Detail render: `knowledge/renders/owner-manual/page-08-detail.png`
- Local OCR: `knowledge/ocr/owner-manual/page-08.txt`
...
MAINTENANCE
Note: When using an optional Spool Gun (sold separately), connect the
Spool GungashosetotheSpoolGunGasOutlet.
Page 8
Fortechnicalquestions,pleasecall1-800-444-3353.
Item 57812

## Visual review

- Front-panel callouts locate Home, Back, LCD, three knobs, power switch, MIG/spool-gun socket and gas outlet, negative/positive sockets, and wire-feed power cable.

---

# owner-manual - PDF page 9

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review, local_ocr`
- Render: `knowledge/renders/owner-manual/page-09.png`
- Detail render: `knowledge/renders/owner-manual/page-09-detail.png`
- Local OCR: `knowledge/ocr/owner-manual/page-09.txt`
...
Page 9
Item57812
Fortechnicalquestions,please call1-800-444-3353.

## Visual review

- Interior callouts locate the spool, spool knob, inlet liner, feed mechanism/tensioner/roller, cold-wire-feed switch, foot-pedal socket, and wire-feed-control socket.
...
# owner-manual - PDF page 11

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-11.png`
- Detail render: `knowledge/renders/owner-manual/page-11-detail.png`
...
- Wire-spool and spool-knob assembly order/orientation were checked against the exploded setup drawings.

---

# owner-manual - PDF page 12

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-12.png`
- Detail render: `knowledge/renders/owner-manual/page-12-detail.png`
...
- Feed-roller groove selection and roller orientation were checked visually against wire-size labels.

---

# owner-manual - PDF page 13

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-13.png`
- Detail render: `knowledge/renders/owner-manual/page-13-detail.png`
...
- Wire-feed routing through inlet, guides, roller, and gun liner was checked against the diagram.

---

# owner-manual - PDF page 14

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-14.png`
- Detail render: `knowledge/renders/owner-manual/page-14-detail.png`
...
- Polarity diagram shows DCEP for solid-wire MIG: wire-feed power positive and ground clamp negative.

---

# owner-manual - PDF page 15

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-15.png`
- Detail render: `knowledge/renders/owner-manual/page-15-detail.png`
...
- Shielding-gas connection sequence and regulator/cylinder arrangement were checked against the illustrated callouts.

---

# owner-manual - PDF page 16

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-16.png`
- Detail render: `knowledge/renders/owner-manual/page-16-detail.png`
...
- Danger callout and gas-cylinder securing/connection illustrations were checked; no conflicting visual instruction found.

---

# owner-manual - PDF page 17

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-17.png`
- Detail render: `knowledge/renders/owner-manual/page-17-detail.png`
...
- Cold-wire-feed and incremental feed-tension procedure was checked; the diagram uses a wood block to test bending at roughly 2–3 inches.
...
# owner-manual - PDF page 19

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-19.png`
- Detail render: `knowledge/renders/owner-manual/page-19-detail.png`
...
- MIG duty-cycle clocks confirm 120 VAC: 4 minutes welding/6 resting at 100 A; 240 VAC: 2.5 minutes welding/7.5 resting at 200 A; 100% ratings are 75 A and 115 A respectively.

---

# owner-manual - PDF page 20

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-20.png`
- Detail render: `knowledge/renders/owner-manual/page-20-detail.png`
...
- MIG process-selection and input-power screen sequence was checked against display screenshots.

---

# owner-manual - PDF page 21

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-21.png`
- Detail render: `knowledge/renders/owner-manual/page-21-detail.png`
...
- MIG material, wire, gas, thickness, voltage, and wire-speed setup screens were checked in their illustrated order.

---

# owner-manual - PDF page 22

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-22.png`
- Detail render: `knowledge/renders/owner-manual/page-22-detail.png`
...
- MIG gun travel-angle, work-angle, CTWD, and direction illustrations were reconciled with the technique text.

---

# owner-manual - PDF page 23

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-23.png`
- Detail render: `knowledge/renders/owner-manual/page-23-detail.png`
...
- Wire-welding bead and travel examples were checked; visual examples support the extracted technique guidance.

---

# owner-manual - PDF page 24

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-24.png`
- Detail render: `knowledge/renders/owner-manual/page-24-detail.png`
...
- TIG cable diagram shows TIG torch in negative, ground clamp in positive, shielding-gas hose connected, and optional foot pedal connected inside.

---

# owner-manual - PDF page 25

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-25.png`
- Detail render: `knowledge/renders/owner-manual/page-25-detail.png`
...
- TIG shielding-gas cylinder, regulator, and hose arrangement was checked against the connection steps.

---

# owner-manual - PDF page 26

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-26.png`
- Detail render: `knowledge/renders/owner-manual/page-26-detail.png`
...
- Tungsten sharpening direction/profile and scratch-start sequence were checked against the diagrams.

---

# owner-manual - PDF page 27

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-27.png`
- Detail render: `knowledge/renders/owner-manual/page-27-detail.png`
...
- Stick diagram shows ground clamp negative and electrode holder positive; power-label table was visually checked.

---

# owner-manual - PDF page 28

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-28.png`
- Detail render: `knowledge/renders/owner-manual/page-28-detail.png`
...
- Basic TIG/Stick startup, mode selection, and control-screen sequence was checked against display illustrations.

---

# owner-manual - PDF page 29

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-29.png`
- Detail render: `knowledge/renders/owner-manual/page-29-detail.png`
...
- Duty-cycle clocks confirm TIG 30% at 175 A/240 VAC and 40% at 125 A/120 VAC; Stick 25% at 175 A/240 VAC and 40% at 80 A/120 VAC, with their illustrated rest periods.

---

# owner-manual - PDF page 30

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-30.png`
- Detail render: `knowledge/renders/owner-manual/page-30-detail.png`
...
- TIG torch/electrode positioning and scratch-start workflow were checked against the numbered illustrations.

---

# owner-manual - PDF page 31

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-31.png`
- Detail render: `knowledge/renders/owner-manual/page-31-detail.png`
...
- TIG arc length, torch angle, filler angle, and travel sequence illustrations were checked against the technique text.

---

# owner-manual - PDF page 32

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-32.png`
- Detail render: `knowledge/renders/owner-manual/page-32-detail.png`
...
- Stick electrode angle, arc length, travel direction, and bead sequence were visually reconciled.

---

# owner-manual - PDF page 33

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-33.png`
- Detail render: `knowledge/renders/owner-manual/page-33-detail.png`
...
- Stick electrode handling and shutdown/safety illustrations were checked against the warning text.

---

# owner-manual - PDF page 34

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-34.png`
- Detail render: `knowledge/renders/owner-manual/page-34-detail.png`
...
- Joint-preparation diagrams cover butt, lap, tee, edge, and corner-style preparations and visually reinforce cleaning/bevel guidance.

---

# owner-manual - PDF page 35

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-35.png`
- Detail render: `knowledge/renders/owner-manual/page-35-detail.png`
...
- Wire-weld penetration profiles distinguish excess/burn-through, proper, and inadequate penetration; arrows relate heat changes to current, travel speed, wire feed, and CTWD.

---

# owner-manual - PDF page 36

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-36.png`
- Detail render: `knowledge/renders/owner-manual/page-36-detail.png`
...
- Wire-weld cross-sections and bend-at-joint examples were checked against listed causes and solutions.

---

# owner-manual - PDF page 37

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-37.png`
- Detail render: `knowledge/renders/owner-manual/page-37-detail.png`
...
- Top-view examples distinguish porosity from excessive spatter; visual defects agree with the diagnostic text.

---

# owner-manual - PDF page 38

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-38.png`
- Detail render: `knowledge/renders/owner-manual/page-38-detail.png`
...
- Stick-weld penetration profiles distinguish excess, proper, and inadequate penetration; example beads map current, speed, and arc-length errors.

---

# owner-manual - PDF page 39

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-39.png`
- Detail render: `knowledge/renders/owner-manual/page-39-detail.png`
...
- Stick-weld profile and adhesion illustrations were checked against causes and corrective actions.

---

# owner-manual - PDF page 40

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-40.png`
- Detail render: `knowledge/renders/owner-manual/page-40-detail.png`
...
- Slag, porosity, crooked/wavy bead, and excessive-spatter examples were checked against their diagnostic sections.

---

# owner-manual - PDF page 41

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-41.png`
- Detail render: `knowledge/renders/owner-manual/page-41-detail.png`
...
- Maintenance schedule/table and component-cleaning illustrations were checked against extracted intervals and procedures.

---

# owner-manual - PDF page 42

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-42.png`
- Detail render: `knowledge/renders/owner-manual/page-42-detail.png`
...
- MIG/flux troubleshooting table preserves Problem → Possible Causes → Likely Solutions relationships for wire-feed and bird-nesting faults.

---

# owner-manual - PDF page 43

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-43.png`
- Detail render: `knowledge/renders/owner-manual/page-43-detail.png`
...
- Continuation of the MIG/flux troubleshooting table was checked column-by-column, including thermal, power, trigger, voltage-protection, and mode faults.

---

# owner-manual - PDF page 44

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-44.png`
- Detail render: `knowledge/renders/owner-manual/page-44-detail.png`
...
- TIG/Stick troubleshooting table was checked column-by-column, preserving each problem’s causes and likely solutions.

---

# owner-manual - PDF page 45

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-45.png`
- Detail render: `knowledge/renders/owner-manual/page-45-detail.png`
...
- Full wiring schematic is retained as a high-resolution render; connector labels and topology should be consulted visually rather than inferred from text order.

---

# owner-manual - PDF page 46

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review`
- Render: `knowledge/renders/owner-manual/page-46.png`
- Detail render: `knowledge/renders/owner-manual/page-46-detail.png`
...
1
42
Rectifier Radiator Support Bar
1
43
Rectifier Radiator
1
...
6
47
Bridge Rectifier Heatsink
1
48
Fast Recovery Diode
2
49
IGBT Heat Sink Support Bar
1
50
IGBT Radiator
1
...
- Parts list columns (part, description, quantity) were checked against the render; repair warning requires certified/licensed technicians.

---

# owner-manual - PDF page 47

- Source: `files/owner-manual.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review, local_ocr`
- Render: `knowledge/renders/owner-manual/page-47.png`
- Detail render: `knowledge/renders/owner-manual/page-47-detail.png`
- Local OCR: `knowledge/ocr/owner-manual/page-47.txt`
...
- Exploded assembly diagram maps numbered components to the page-46 parts list; the render is authoritative for spatial relationships.

---

# owner-manual - PDF page 48

- Source: `files/owner-manual.pdf`
- Classification: `text_only`
- Extraction paths: `deterministic_text`
...
# quick-start-guide - PDF page 1

- Source: `files/quick-start-guide.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review, local_ocr`
- Render: `knowledge/renders/quick-start-guide/page-01.png`
- Detail render: `knowledge/renders/quick-start-guide/page-01-detail.png`
- Local OCR: `knowledge/ocr/quick-start-guide/page-01.txt`
...
### 2 lb Spool Loading
### Adapter and knob required for 10-12 lb spool
...
220
57812
Connect cables as needed for flux
wire welding -seeback of guide.
Feed
Wingnut
Mechanism
Spacer-
...
2Ib
feed guides and clamp
Wire
feed
it into feed mechanism.
loods
guides
Welder
See manual if
...
or using solid wire.
Wire Spool
Adapterandknobrequiredfor10-12Ibspool
Take off nozzle and tip,
AWARNING
plug selected cord into
To prevent serious
Contact
welder and into wall.
injury, read
Tip
turn welder on, and press
manual warnings
and instructions
cold wire feed switch
Nozzle
before use.
until wire comes out.
AWARNING
clockwise
...
Hold gun clear of workpiece, then plug in welder,
turn it on, and set weld thickness and other settings.
HOLD
GUN
VULCAN.
220
CLEAR
BASICWELDINGINSTRUCTIONSANDWELDINGTIPSAREINMANUAL.

## Visual review

- Flux-wire quick start: install spool, route and clamp wire, remove nozzle/tip, cold-feed wire, tighten tension until wire bends against a wood block at 2–3 inches, reinstall nozzle/tip, then select settings and test.

---

# quick-start-guide - PDF page 2

- Source: `files/quick-start-guide.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review, local_ocr`
- Render: `knowledge/renders/quick-start-guide/page-02.png`
- Detail render: `knowledge/renders/quick-start-guide/page-02-detail.png`
- Local OCR: `knowledge/ocr/quick-start-guide/page-02.txt`
...
FLUX CABLE SETUP
4. Connect wire feed
Follow MiG cable setup but connect
control inside welder.
ground clamp to positive terminal and
wire feed power to negative terminal.
TIG CABLE SETUP
1. Connect ground clamp
to positive terminal.
2. Connect TIG torch to
negative terminal.
3. Connect gas line
to gas regulator.
4. Connect foot pedal
inside welder.
5. Leave wire feed
power disconnected.
BASICWELDINGINSTRUCTIONSANDWELDINGTIPSAREINMANUAL.
...
- Cable diagrams: Stick = ground negative/electrode positive; MIG = ground negative/wire-feed power positive; Flux reverses those MIG polarities; TIG = ground positive/torch negative with gas and optional foot pedal.

---

# selection-chart - PDF page 1

- Source: `files/selection-chart.pdf`
- Classification: `complex`
- Extraction paths: `deterministic_text, rendered_visual_review, local_ocr`
- Render: `knowledge/renders/selection-chart/page-01.png`
- Detail render: `knowledge/renders/selection-chart/page-01-detail.png`
- Local OCR: `knowledge/ocr/selection-chart/page-01.txt`
...
HOW TO CHOOSE
WELDER
IDENTIFYYOURINPUTVOLTAGE:
IMPORTANT!
D0 Y0UHAVE 120V0LT 0R240V0LT?
MIG or FLUX CORED?
LOW
LoW
MODERATE
...
+Galvanized steel
Structuralsteel
+Stainless steelexhausts·Bicycle franes
+General fabrication
TEINMTELLS
TYPICALAPPLICATIONS
Buqn*
Thin wall pipe& tubing·Metal art
+Pipe and tubing
URE SRLET NEDL
+Strucural stoel
Maintenance&ropalr
...
SPATTER
CLEAN
DO YOU NEED YOUR WELD?
SPATTER
numbar ef minree, wihn e 19 mirrte
Wuhiting.
FLUX-CORED/FCAW
MIG/GMAW
TIG/GTAW
STICK/SMAW
DUTY CYCLEEXAMPLE
(spods fupom qfnd uognpoad s +
•Highest quality welds
Ideal for outdoor or windyconditions
USE THIS
+Ideal for outdeer or windy conditiens
165A@30%Duty Cyele
Forgiving on rusty or dirty steels
Easiest to leam
WELDING PROCESS
Forgiving en rusty or dirty steels
Extremely aeshetic weld appearance
3Mlnates
7 MInutes
Good out ef position welding capabilities
Deep penotration
•Clean welds with me slag
+Can be used on a variety of materials
Welding
Resting
High deposition rates achievable
+Precise control
Better control en thin raterials
Good choice forthicker materials

## Visual review

- Decision chart compares Flux-Cored, MIG, Stick, and TIG by skill, gas, materials, thickness, applications, cleanliness, and input voltage; the process columns and 165 A at 30% duty-cycle example were visually checked.
...
- Detail render: `knowledge/source-images/product-detail.png`
- Local OCR: `knowledge/ocr/source-images/product.txt`
...
- Exterior product view confirms the OmniPro 220 front LCD, Home/Back buttons, three control knobs, power switch, MIG/spool-gun socket, negative/positive output sockets, and wire-feed power lead.
...
- Detail render: `knowledge/source-images/product-front-detail.png`
- Local OCR: `knowledge/ocr/source-images/product-front.txt`
- Dimensions: `1200x1200`
...
- Head-on front product view. Confirms the same front controls page 8 labels: LCD, Home/Back buttons, three control knobs, power switch, MIG/spool-gun cable socket, spool-gun gas outlet, negative and positive output sockets, and the wire-feed power lead. Used as the hotspot canvas because its near-orthographic framing matches the page-8 line drawing; the photograph itself is never resampled.
...
- Detail render: `knowledge/source-images/product-inside-detail.png`
- Local OCR: `knowledge/ocr/source-images/product-inside.txt`
- Dimensions: `1200x1200`
...
- Open-door product view confirms the interior spool/feed layout and placards for rated duty cycles, MIG/Flux, TIG, Stick, wire-spool setup, and wire-feed setup; small placard text is corroborative, not the primary numeric source.
